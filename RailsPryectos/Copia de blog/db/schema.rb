...
ActiveRecord::Schema.define(version: 20180401182834) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.string "cat_img_file_name"
    t.string "cat_img_content_type"
    t.integer "cat_img_file_size"
    t.datetime "cat_img_updated_at"
